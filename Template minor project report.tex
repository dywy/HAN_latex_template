...
\usepackage{csquotes}
\usepackage[page,titletoc, title,header]{appendix}
...
\renewcommand\nomgroup[1]{%
  \item[\bfseries
  \ifstrequal{#1}{D}{Definitions}{%
  \ifstrequal{#1}{A}{Abbreviations}{%
  \ifstrequal{#1}{S}{Symbols}{}}}%
  ]
}
%\usepackage[]{media9} %for future use to embed U3D files
...
\nomenclature[A]{EGT}{Exhaust Gas Temperature}
\nomenclature[S]{$\pi$}{A mathematical constant}
\nomenclature[D]{Exhaust Gas}{Emitted as a result of the combustion of fuels}
